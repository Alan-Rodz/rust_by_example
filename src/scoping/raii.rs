/*
    ...
    so you'll never have to manually free memory or worry 
    about memory leaks again!
    ...
    only implement it for your type if you require 
    its own destructor logic.

    Run the below example to see how the Drop trait works. 
    When the variable in the main function goes out of scope the 
    custom destructor will be invoked.
