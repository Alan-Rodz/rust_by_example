/*
    ...
    The main use of the Drop trait is to free the resources that
    ...
    The following example adds a print to console to the 
    drop function to announce when it is called.
